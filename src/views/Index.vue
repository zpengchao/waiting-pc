    ...
    <main class="connect_box">
        ...
        <div class="home-module" id="wangwang">
            ...
            <div class="home-module_list">
                <ul>
                    <li v-if="doglist[0]" v-for="(item) in doglist" :key="item.index" @click="look(item)">
                        <div class="list_tu">
                        <a href="javascript:;">
        ...
        <div class="home-module">
            ...
            <div class="home-module_list">
                 <ul>
                     <li v-if="catlist[0]" v-for="(item) in catlist" :key="item.index" @click="look(item)">
                        <div class="list_tu">
                        <a href="javascript:;">
                            <img :src="item.img1" alt="">
                        </a>
        ...
        <div class="home-module">
            ...
            <div class="home-module_list">
                <ul>
                    <li v-if="otherlist[0]" v-for="(item) in otherlist" :key="item.index" @click="look(item)">
                        <div class="list_tu">
                        <a href="javascript:;">
                            <img :src="item.img1" alt="">
                        </a>
