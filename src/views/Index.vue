    ...
    <main class="connect_box">
        ...
        <div class="home-module" id="wangwang">
            ...
            <div class="pet_top">
                ...
                <router-link to="/adoption" name="wang_datu">查看更多</router-link>
                <div class="box_yy"></div>
            </div>
            <div class="home-module_list">
                <ul>
                    <li v-if="doglist[0]" v-for="(item,index) in doglist" :key="item.index" @click="look(item)">
                        <div class="list_tu">
                        <a href="javascript:;">
                            <img :src="item.img1" alt="">
                        </a>
                        </div>
                        <h6><i>{{item.pname.length>=11 ? item.pname.slice(0,11)+"..." : item.pname}}</i></h6>
                        <p>简介: <span>{{item.intro.length>=15 ? item.intro.slice(0,15)+"..." : item.intro}}</span></p>
        ...
        <div class="home-module">
            ...
            <div class="home-module_list">
                 <ul>
                     <li v-if="catlist[0]" v-for="(item,index) in catlist" :key="item.index" @click="look(item)">
                        <div class="list_tu">
                        <a href="javascript:;">
                            <img :src="item.img1" alt="">
                        </a>
        ...
        <div class="home-module">
            ...
            <div class="home-module_list">
                <ul>
                    <li v-if="otherlist[0]" v-for="(item,index) in otherlist" :key="item.index" @click="look(item)">
                        <div class="list_tu">
                        <a href="javascript:;">
                            <img :src="item.img1" alt="">
                        </a>
...
<script>
    export default {
        ...
        methods: {
            look(e){
            sessionStorage.setItem("ser_id", e.ser_id)
...
/* 图片下文字 */
.home-module .home-module_list ul li h6 i{
	font-size:22px;
	color:#684029;
}
...
.home-module .home-module_list ul li p i{
	font-size:16px;
	color:#684029;
}
